...
void *abb_quitar(abb_t *arbol, void *elemento) {
  ...
  nodo_abb_t *nodo_padre = abb_padre_de_nodo_buscado(
      arbol->nodo_raiz, arbol->nodo_raiz, elemento, arbol->comparador);
  ...
  if (nodo_padre == arbol->nodo_raiz &&
    ...
    nodo_buscado = nodo_padre;
             ...
             arbol->comparador(nodo_padre->derecha->elemento, elemento) == 0) {
...
size_t abb_recorrer_nodo_inorden(nodo_abb_t *nodo, void **array,
  ...
  (*p_contador)++;
  // imprime_array(array,(*p_contador));
  (*p_contador) = abb_recorrer_nodo_inorden(nodo->derecha, array, tamanio_array,
                                            p_contador, ejecucion);
  return *p_contador;
}
...
size_t abb_recorrer(abb_t *arbol, abb_recorrido recorrido, void **array,
  ...
  case PREORDEN:
    contador = abb_recorrer_nodo_preorden(arbol->nodo_raiz, array,
                                          tamanio_array, &contador, &ejecucion);
    break;
  case INORDEN:
    contador = abb_recorrer_nodo_inorden(arbol->nodo_raiz, array, tamanio_array,
                                         &contador, &ejecucion);
    break;
  case POSTORDEN:
    contador = abb_recorrer_nodo_postorden(
        arbol->nodo_raiz, array, tamanio_array, &contador, &ejecucion);
    break;
  default:
    break;
  }
